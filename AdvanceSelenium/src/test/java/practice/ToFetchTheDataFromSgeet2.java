...
public class ToFetchTheDataFromSgeet2 {
	...
	public static void main(String[] args) throws IOException {
		...
		wb.getSheet("Organization").getRow(1).getCell(2).getStringCellValue();
		...
		if (BROWSER.equalsIgnoreCase("chrome")) {
			driver=new ChromeDriver();
				...
				driver.findElement(By.name("accountname")).sendKeys("Qspider22"+value);
				...
				if (Oragnization.contains("Qspider22")) {
